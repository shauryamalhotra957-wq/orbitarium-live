# orbitarium-live: Architecture & System Topology

**Domain**: Real-Time Keplerian Orbital Telemetry & Satellite Constellation Visualizer  
**System Mission**: SGP4-propagated 3D orbital mechanics visualizer tracking Low Earth Orbit (LEO) satellite constellations, calculating ground track footprints, and predicting conjunction collision risks.
...
sequenceDiagram
    ...
    participant Engine as orbitarium-live Core
