# orbitarium-live: STRIDE Threat Model & Security Posture

Operational security assessment for **Real-Time Keplerian Orbital Telemetry & Satellite Constellation Visualizer**.
